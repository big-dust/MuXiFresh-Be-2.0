...
// 	protoc        v4.22.2
// source: usercenter(example).proto
...
var file_usercenter_proto_depIdxs = []int32{
	...
	1, // 1: pb.usercenter(example).getVerificationCode:input_type -> pb.VerificationCodeRequest
	3, // 2: pb.usercenter(example).register:input_type -> pb.RegisterRequest
	5, // 3: pb.usercenter(example).getInfo:input_type -> pb.GetInfoRequest
	2, // 4: pb.usercenter(example).getVerificationCode:output_type -> pb.VerificationCodeResponse
	4, // 5: pb.usercenter(example).register:output_type -> pb.RegisterResponse
	6, // 6: pb.usercenter(example).getInfo:output_type -> pb.GetInfoResponse

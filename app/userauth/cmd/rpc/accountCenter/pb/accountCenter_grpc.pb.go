...
const (
	...
	AccountCenterClient_ExistEmail_FullMethodName   = "/accountCenter.accountCenterClient/ExistEmail"
)
...
func (c *accountCenterClientClient) ExistEmail(ctx context.Context, in *ExistEmailReq, opts ...grpc.CallOption) (*ExistEmailResp, error) {
	out := new(ExistEmailResp)
	err := c.cc.Invoke(ctx, AccountCenterClient_ExistEmail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AccountCenterClientServer interface {
	...
	ExistEmail(context.Context, *ExistEmailReq) (*ExistEmailResp, error)
...
func (UnimplementedAccountCenterClientServer) ExistEmail(context.Context, *ExistEmailReq) (*ExistEmailResp, error) {
...
func _AccountCenterClient_ExistEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ExistEmailReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AccountCenterClientServer).ExistEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AccountCenterClient_ExistEmail_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountCenterClientServer).ExistEmail(ctx, req.(*ExistEmailReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AccountCenterClient_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AccountCenterClient_ExistEmail_Handler,
		},
	},
